...
to go
  ask agents [
    ...
    if transmissionType = "encounter" [encounter] ;; call horizanal transmission procedure, where information it transmitted to another agent encountered while moving
